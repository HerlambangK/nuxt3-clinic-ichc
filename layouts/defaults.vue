    ...
    <UiNavbar sticky>
      <UiContainer class="flex h-14 items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          <UiButton external to="#" target="_blank" variant="ghost" size="icon-sm" title="View on github">
          ...
          <UiDropdownMenu>
            ...
            <UiDropdownMenuContent align="end" :side-offset="5">
              <UiDropdownMenuItem class="cursor-pointer" v-for="(m, i) in modes" :key="i" :icon="m.icon"
                :title="m.title" @click="setTheme(m.value)" />
